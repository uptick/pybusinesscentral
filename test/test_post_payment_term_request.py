...
class TestPostPaymentTermRequest(unittest.TestCase):
    """PostPaymentTermRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostPaymentTermRequest:
        """Test PostPaymentTermRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostPaymentTermRequest`
        """
        model = PostPaymentTermRequest()
        if include_optional:
            return PostPaymentTermRequest(
                id = '',
                code = '',
                display_name = '',
    ...
    def testPostPaymentTermRequest(self):
        """Test PostPaymentTermRequest"""
