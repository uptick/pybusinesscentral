...
class TestPostSalesInvoiceRequest(unittest.TestCase):
    """PostSalesInvoiceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostSalesInvoiceRequest:
        """Test PostSalesInvoiceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostSalesInvoiceRequest`
        """
        model = PostSalesInvoiceRequest()
        if include_optional:
            return PostSalesInvoiceRequest(
                id = '',
                number = '',
    ...
    def testPostSalesInvoiceRequest(self):
        """Test PostSalesInvoiceRequest"""
