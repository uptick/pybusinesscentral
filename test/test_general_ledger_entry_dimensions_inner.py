...
class TestGeneralLedgerEntryDimensionsInner(unittest.TestCase):
    """GeneralLedgerEntryDimensionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneralLedgerEntryDimensionsInner:
        """Test GeneralLedgerEntryDimensionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneralLedgerEntryDimensionsInner`
        """
        model = GeneralLedgerEntryDimensionsInner()
        if include_optional:
            return GeneralLedgerEntryDimensionsInner(
                code = '',
                display_name = '',
                value_code = '',
                value_display_name = '',
    ...
    def testGeneralLedgerEntryDimensionsInner(self):
        """Test GeneralLedgerEntryDimensionsInner"""
