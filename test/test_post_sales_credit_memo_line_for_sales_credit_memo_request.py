...
class TestPostSalesCreditMemoLineForSalesCreditMemoRequest(unittest.TestCase):
    """PostSalesCreditMemoLineForSalesCreditMemoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostSalesCreditMemoLineForSalesCreditMemoRequest:
        """Test PostSalesCreditMemoLineForSalesCreditMemoRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostSalesCreditMemoLineForSalesCreditMemoRequest`
        """
        model = PostSalesCreditMemoLineForSalesCreditMemoRequest()
        if include_optional:
            return PostSalesCreditMemoLineForSalesCreditMemoRequest(
                id = '',
                document_id = '',
                sequence = 56,
                item_id = '',
    ...
    def testPostSalesCreditMemoLineForSalesCreditMemoRequest(self):
        """Test PostSalesCreditMemoLineForSalesCreditMemoRequest"""
