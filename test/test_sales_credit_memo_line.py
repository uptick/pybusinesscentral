...
class TestSalesCreditMemoLine(unittest.TestCase):
    """SalesCreditMemoLine unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesCreditMemoLine:
        """Test SalesCreditMemoLine
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesCreditMemoLine`
        """
    ...
    def testSalesCreditMemoLine(self):
        """Test SalesCreditMemoLine"""
