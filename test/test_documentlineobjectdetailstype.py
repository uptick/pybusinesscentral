...
class TestDocumentlineobjectdetailstype(unittest.TestCase):
    """Documentlineobjectdetailstype unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Documentlineobjectdetailstype:
        """Test Documentlineobjectdetailstype
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Documentlineobjectdetailstype`
        """
        model = Documentlineobjectdetailstype()
        if include_optional:
            return Documentlineobjectdetailstype(
                number = '',
                display_name = '',
    ...
    def testDocumentlineobjectdetailstype(self):
        """Test Documentlineobjectdetailstype"""
