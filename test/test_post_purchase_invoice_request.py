...
class TestPostPurchaseInvoiceRequest(unittest.TestCase):
    """PostPurchaseInvoiceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostPurchaseInvoiceRequest:
        """Test PostPurchaseInvoiceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostPurchaseInvoiceRequest`
        """
        model = PostPurchaseInvoiceRequest()
        if include_optional:
            return PostPurchaseInvoiceRequest(
                ...
                pay_to_address = pybusinesscentral.model.postaladdresstype.postaladdresstype(
                    ...
                    payment_method = pybusinesscentral.model.payment_method.paymentMethod(
                        ...
                        display_name = '', 
                        last_modified_date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ), ),
                ship_to_address = pybusinesscentral.model.postaladdresstype.postaladdresstype(
                    street = '', 
                    city = '', 
                    state = '', 
                    country_letter_code = '', 
    ...
    def testPostPurchaseInvoiceRequest(self):
        """Test PostPurchaseInvoiceRequest"""
