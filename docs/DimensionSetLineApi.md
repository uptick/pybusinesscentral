...
------------- | ------------- | -------------
[**get_dimension_set_lines_for_journal_line**](DimensionSetLineApi.md#get_dimension_set_lines_for_journal_line) | **GET** /companies({company_id})/journals({journal_id})/journalLines({journalLine_id})/dimensionSetLines | Retrieve the properties and relationships of the list of dimensionSetLines for a journalLine.
...
[**post_journal_line_dimension_set_line**](DimensionSetLineApi.md#post_journal_line_dimension_set_line) | **POST** /companies({company_id})/journals({journal_id})/journalLines({journalLine_id})/dimensionSetLines | Creates an object of type dimensionSetLine in Dynamics 365 Business Central
...
# **get_dimension_set_lines_for_journal_line**
> DimensionSetLine get_dimension_set_lines_for_journal_line(company_id, journal_id, journal_line_id)

Retrieve the properties and relationships of the list of dimensionSetLines for a journalLine.
...
with pybusinesscentral.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve the properties and relationships of the list of dimensionSetLines for a journalLine.
        api_response = api_instance.get_dimension_set_lines_for_journal_line(company_id, journal_id, journal_line_id)
        print("The response of DimensionSetLineApi->get_dimension_set_lines_for_journal_line:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DimensionSetLineApi->get_dimension_set_lines_for_journal_line: %s\n" % e)
```
...
# **post_journal_line_dimension_set_line**
> DimensionSetLine post_journal_line_dimension_set_line(company_id, journal_id, journal_line_id, content_type, post_journal_line_dimension_set_line_request)
...
with pybusinesscentral.ApiClient(configuration) as api_client:
    ...
    post_journal_line_dimension_set_line_request = pybusinesscentral.PostJournalLineDimensionSetLineRequest() # PostJournalLineDimensionSetLineRequest | 

    try:
        # Creates an object of type dimensionSetLine in Dynamics 365 Business Central
        api_response = api_instance.post_journal_line_dimension_set_line(company_id, journal_id, journal_line_id, content_type, post_journal_line_dimension_set_line_request)
        print("The response of DimensionSetLineApi->post_journal_line_dimension_set_line:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DimensionSetLineApi->post_journal_line_dimension_set_line: %s\n" % e)
```
 ...
 **post_journal_line_dimension_set_line_request** | [**PostJournalLineDimensionSetLineRequest**](PostJournalLineDimensionSetLineRequest.md)|  | 
