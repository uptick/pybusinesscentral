...
class Itemunitofmeasureconversiontype(BaseModel):
    """
    Itemunitofmeasureconversiontype
    """ # noqa: E501
    to_unit_of_measure: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(default=None, description="(v1.0) The toUnitOfMeasure property for the Dynamics 365 Business Central itemunitofmeasureconversiontype entity", alias="toUnitOfMeasure")
    from_to_conversion_rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(v1.0) The fromToConversionRate property for the Dynamics 365 Business Central itemunitofmeasureconversiontype entity", alias="fromToConversionRate")
    ...
    __properties: ClassVar[List[str]] = ["toUnitOfMeasure", "fromToConversionRate", "picture", "defaultDimensions", "itemCategory"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if to_unit_of_measure (nullable) is None
        # and model_fields_set contains the field
        if self.to_unit_of_measure is None and "to_unit_of_measure" in self.model_fields_set:
            _dict['toUnitOfMeasure'] = None

        # set to None if from_to_conversion_rate (nullable) is None
        # and model_fields_set contains the field
        if self.from_to_conversion_rate is None and "from_to_conversion_rate" in self.model_fields_set:
            _dict['fromToConversionRate'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "toUnitOfMeasure": obj.get("toUnitOfMeasure"),
            "fromToConversionRate": obj.get("fromToConversionRate"),
