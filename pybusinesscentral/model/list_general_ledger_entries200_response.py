...
class ListGeneralLedgerEntries200Response(BaseModel):
    """
    ListGeneralLedgerEntries200Response
    """ # noqa: E501
    value: Optional[List[GeneralLedgerEntry]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [GeneralLedgerEntry.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
