...
class PostPurchaseInvoiceLineForPurchaseInvoiceRequest(BaseModel):
    """
    PostPurchaseInvoiceLineForPurchaseInvoiceRequest
    """ # noqa: E501
    id: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="(v1.0) The id property for the Dynamics 365 Business Central purchaseInvoiceLine entity")
    document_id: Optional[StrictStr] = Field(default=None, description="(v1.0) The documentId property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="documentId")
    sequence: Optional[StrictInt] = Field(default=None, description="(v1.0) The sequence property for the Dynamics 365 Business Central purchaseInvoiceLine entity")
    item_id: Optional[StrictStr] = Field(default=None, description="(v1.0) The itemId property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="itemId")
    account_id: Optional[StrictStr] = Field(default=None, description="(v1.0) The accountId property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="accountId")
    line_type: Optional[StrictStr] = Field(default=None, description="(v1.0) The lineType property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="lineType")
    line_details: Optional[Documentlineobjectdetailstype] = Field(default=None, alias="lineDetails")
    description: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="(v1.0) The description property for the Dynamics 365 Business Central purchaseInvoiceLine entity")
    unit_of_measure: Optional[Unitofmeasuretype] = Field(default=None, alias="unitOfMeasure")
    unit_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(v1.0) The unitCost property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="unitCost")
    quantity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(v1.0) The quantity property for the Dynamics 365 Business Central purchaseInvoiceLine entity")
    discount_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(v1.0) The discountAmount property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="discountAmount")
    discount_percent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(v1.0) The discountPercent property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="discountPercent")
    discount_applied_before_tax: Optional[StrictBool] = Field(default=None, description="(v1.0) The discountAppliedBeforeTax property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="discountAppliedBeforeTax")
    amount_excluding_tax: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(v1.0) The amountExcludingTax property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="amountExcludingTax")
    tax_code: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="(v1.0) The taxCode property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="taxCode")
    tax_percent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(v1.0) The taxPercent property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="taxPercent")
    total_tax_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(v1.0) The totalTaxAmount property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="totalTaxAmount")
    amount_including_tax: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(v1.0) The amountIncludingTax property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="amountIncludingTax")
    invoice_discount_allocation: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(v1.0) The invoiceDiscountAllocation property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="invoiceDiscountAllocation")
    net_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(v1.0) The netAmount property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="netAmount")
    net_tax_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(v1.0) The netTaxAmount property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="netTaxAmount")
    net_amount_including_tax: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="(v1.0) The netAmountIncludingTax property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="netAmountIncludingTax")
    expected_receipt_date: Optional[date] = Field(default=None, description="(v1.0) The expectedReceiptDate property for the Dynamics 365 Business Central purchaseInvoiceLine entity", alias="expectedReceiptDate")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if expected_receipt_date (nullable) is None
        # and model_fields_set contains the field
        if self.expected_receipt_date is None and "expected_receipt_date" in self.model_fields_set:
            _dict['expectedReceiptDate'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expectedReceiptDate": obj.get("expectedReceiptDate")
        })
        return _obj
