...
class Vendor(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): (v1.0) The id property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
            number (str, none_type): (v1.0) The number property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
            display_name (str, none_type): (v1.0) The displayName property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
            ...
            phone_number (str, none_type): (v1.0) The phoneNumber property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
            email (str, none_type): (v1.0) The email property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
            website (str, none_type): (v1.0) The website property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
            tax_registration_number (str, none_type): (v1.0) The taxRegistrationNumber property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
            currency_id (str, none_type): (v1.0) The currencyId property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
            currency_code (str, none_type): (v1.0) The currencyCode property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
            irs1099_code (str, none_type): (v1.0) The irs1099Code property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
            payment_terms_id (str, none_type): (v1.0) The paymentTermsId property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
            payment_method_id (str, none_type): (v1.0) The paymentMethodId property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
            tax_liable (bool, none_type): (v1.0) The taxLiable property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
            blocked (str, none_type): (v1.0) The blocked property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
            balance (float, none_type): (v1.0) The balance property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
            last_modified_date_time (datetime, none_type): (v1.0) The lastModifiedDateTime property for the Dynamics 365 Business Central vendor entity. [optional]  # noqa: E501
