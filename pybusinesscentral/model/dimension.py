...
class Dimension(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): (v1.0) The id property for the Dynamics 365 Business Central dimension entity. [optional]  # noqa: E501
            code (str, none_type): (v1.0) The code property for the Dynamics 365 Business Central dimension entity. [optional]  # noqa: E501
            display_name (str, none_type): (v1.0) The displayName property for the Dynamics 365 Business Central dimension entity. [optional]  # noqa: E501
            last_modified_date_time (datetime, none_type): (v1.0) The lastModifiedDateTime property for the Dynamics 365 Business Central dimension entity. [optional]  # noqa: E501
