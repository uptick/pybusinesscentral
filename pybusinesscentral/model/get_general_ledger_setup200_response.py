...
class GetGeneralLedgerSetup200Response(BaseModel):
    """
    GetGeneralLedgerSetup200Response
    """ # noqa: E501
    value: Optional[List[GeneralLedgerSetup]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetGeneralLedgerSetup200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetGeneralLedgerSetup200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "value": [GeneralLedgerSetup.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
