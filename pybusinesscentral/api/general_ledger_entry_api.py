...
class GeneralLedgerEntryApi:
    ...
    def list_general_ledger_entries(
        ...
        _param = self._list_general_ledger_entries_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListGeneralLedgerEntries200Response",
        }
    ...
    @validate_call
    def list_general_ledger_entries_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        top: Annotated[Optional[StrictInt], Field(description="(v1.0) Number of items to return from the top of the list")] = None,
        skip: Annotated[Optional[StrictInt], Field(description="(v1.0) Number of items to skip from the list")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListGeneralLedgerEntries200Response]:
        """Returns a list of generalLedgerEntries
    ...
    @validate_call
    def list_general_ledger_entries_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        top: Annotated[Optional[StrictInt], Field(description="(v1.0) Number of items to return from the top of the list")] = None,
        skip: Annotated[Optional[StrictInt], Field(description="(v1.0) Number of items to skip from the list")] = None,
    ...
    def _list_general_ledger_entries_serialize(
        self,
        company_id,
        top,
        skip,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/companies({company_id})/generalLedgerEntries',
