...
class DefaultApi:
    ...
    def get_general_ledger_setup(
        ...
        _param = self._get_general_ledger_setup_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetGeneralLedgerSetup200Response",
        }
    ...
    @validate_call
    def get_general_ledger_setup_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetGeneralLedgerSetup200Response]:
        """Returns a generalLedgerSetup
    ...
    @validate_call
    def get_general_ledger_setup_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        _request_timeout: Union[
            None,
    ...
    def _get_general_ledger_setup_serialize(
        self,
        company_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/companies({company_id})/generalLedgerSetup',
