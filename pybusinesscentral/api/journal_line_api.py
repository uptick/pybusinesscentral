...
class JournalLineApi:
    ...
    @validate_call
    def delete_journal_line_for_journal(
        self,
        ...
        journal_line_id: Annotated[StrictStr, Field(description="(v1.0) id for journalLine")],
        ...
        :type journal_id: str
        :param journal_line_id: (v1.0) id for journalLine (required)
        ...
        _param = self._delete_journal_line_for_journal_serialize(
    ...
    @validate_call
    def delete_journal_line_for_journal_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        journal_id: Annotated[StrictStr, Field(description="(v1.0) id for journal")],
        journal_line_id: Annotated[StrictStr, Field(description="(v1.0) id for journalLine")],
    ...
    @validate_call
    def delete_journal_line_for_journal_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        journal_id: Annotated[StrictStr, Field(description="(v1.0) id for journal")],
        journal_line_id: Annotated[StrictStr, Field(description="(v1.0) id for journalLine")],
    ...
    def _delete_journal_line_for_journal_serialize(
        self,
        company_id,
        journal_id,
        journal_line_id,
        ...
        if journal_line_id is not None:
            _path_params['journalLine_id'] = journal_line_id
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/companies({company_id})/journals({journal_id})/journalLines({journalLine_id})',
    ...
    @validate_call
    def list_journal_lines_for_journal(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        journal_id: Annotated[StrictStr, Field(description="(v1.0) id for journal")],
        ...
        _param = self._list_journal_lines_for_journal_serialize(
            company_id=company_id,
            journal_id=journal_id,
            top=top,
            skip=skip,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListJournalLinesForJournal200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_journal_lines_for_journal_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        journal_id: Annotated[StrictStr, Field(description="(v1.0) id for journal")],
        top: Annotated[Optional[StrictInt], Field(description="(v1.0) Number of items to return from the top of the list")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListJournalLinesForJournal200Response]:
        """Returns a list of journalLines
    ...
    @validate_call
    def list_journal_lines_for_journal_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        journal_id: Annotated[StrictStr, Field(description="(v1.0) id for journal")],
        top: Annotated[Optional[StrictInt], Field(description="(v1.0) Number of items to return from the top of the list")] = None,
    ...
    def _list_journal_lines_for_journal_serialize(
        self,
        company_id,
        journal_id,
        top,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/companies({company_id})/journals({journal_id})/journalLines',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_journal_line_for_journal(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        journal_id: Annotated[StrictStr, Field(description="(v1.0) id for journal")],
        journal_line_id: Annotated[StrictStr, Field(description="(v1.0) id for journalLine")],
        ...
        if_match: Annotated[StrictStr, Field(description="(v1.0) Required. When this request header is included and the eTag provided does not match the current tag on the entity, this will not be updated.")],
        post_journal_line_for_journal_request: PostJournalLineForJournalRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param if_match: (v1.0) Required. When this request header is included and the eTag provided does not match the current tag on the entity, this will not be updated. (required)
        :type if_match: str
        :param post_journal_line_for_journal_request: (required)
        :type post_journal_line_for_journal_request: PostJournalLineForJournalRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_journal_line_for_journal_serialize(
            company_id=company_id,
            journal_id=journal_id,
            journal_line_id=journal_line_id,
            content_type=content_type,
            if_match=if_match,
            post_journal_line_for_journal_request=post_journal_line_for_journal_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def patch_journal_line_for_journal_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        journal_id: Annotated[StrictStr, Field(description="(v1.0) id for journal")],
        journal_line_id: Annotated[StrictStr, Field(description="(v1.0) id for journalLine")],
    ...
    @validate_call
    def patch_journal_line_for_journal_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        journal_id: Annotated[StrictStr, Field(description="(v1.0) id for journal")],
        journal_line_id: Annotated[StrictStr, Field(description="(v1.0) id for journalLine")],
    ...
    def _patch_journal_line_for_journal_serialize(
        self,
        company_id,
        journal_id,
        journal_line_id,
        content_type,
        if_match,
        post_journal_line_for_journal_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_journal_line_for_journal_request is not None:
            _body_params = post_journal_line_for_journal_request
    ...
    def post_journal_line_for_journal(
        ...
        _param = self._post_journal_line_for_journal_serialize(
            company_id=company_id,
            journal_id=journal_id,
            content_type=content_type,
            post_journal_line_for_journal_request=post_journal_line_for_journal_request,
    ...
    @validate_call
    def post_journal_line_for_journal_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        journal_id: Annotated[StrictStr, Field(description="(v1.0) id for journal")],
        content_type: Annotated[StrictStr, Field(description="(v1.0) application/json")],
    ...
    @validate_call
    def post_journal_line_for_journal_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        journal_id: Annotated[StrictStr, Field(description="(v1.0) id for journal")],
        content_type: Annotated[StrictStr, Field(description="(v1.0) application/json")],
    ...
    def _post_journal_line_for_journal_serialize(
        self,
        company_id,
        journal_id,
        content_type,
