...
class SalesInvoiceLineApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __delete_sales_invoice_line(
            self,
            company_id,
            ...
            **kwargs
            ...
            >>> thread = api.delete_sales_invoice_line(company_id, sales_invoice_line_id, async_req=True)
            >>> result = thread.get()
        ...
        self.delete_sales_invoice_line = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'oAuth'
                ],
                'endpoint_path': '/companies({company_id})/salesInvoiceLines('{salesInvoiceLine_id}')',
                'operation_id': 'delete_sales_invoice_line',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            callable=__delete_sales_invoice_line
        )
        ...
        def __get_sales_invoice_line(
            ...
            **kwargs
            ...
            >>> thread = api.get_sales_invoice_line(company_id, sales_invoice_line_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_sales_invoice_line = _Endpoint(
            settings={
                ...
                'endpoint_path': '/companies({company_id})/salesInvoiceLines('{salesInvoiceLine_id}')',
                'operation_id': 'get_sales_invoice_line',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_sales_invoice_line
        )
        ...
        def __patch_sales_invoice_line(
            self,
            company_id,
            sales_invoice_line_id,
            content_type,
            ...
            **kwargs
            ...
            >>> thread = api.patch_sales_invoice_line(company_id, sales_invoice_line_id, content_type, if_match, sales_invoice_line, async_req=True)
            >>> result = thread.get()
        ...
        self.patch_sales_invoice_line = _Endpoint(
            settings={
                'response_type': (SalesInvoiceLine,),
                'auth': [
                    'oAuth'
                ...
                'endpoint_path': '/companies({company_id})/salesInvoiceLines('{salesInvoiceLine_id}')',
                'operation_id': 'patch_sales_invoice_line',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__patch_sales_invoice_line
        )
