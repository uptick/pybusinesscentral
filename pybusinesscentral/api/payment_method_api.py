    ...
    def __init__(self, api_client=None):
        ...
        self.delete_payment_method = _Endpoint(
            settings={
                ...
                'endpoint_path': '/companies({company_id})/paymentMethods({paymentMethod_id})',
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'payment_method_id': 'paymentMethod_id',
                },
                'location_map': {
                    'company_id': 'path',
        ...
        self.list_payment_methods = _Endpoint(
            settings={
                ...
                'endpoint_path': '/companies({company_id})/paymentMethods',
        ...
        def __patch_payment_method(
            ...
            **kwargs
            ...
            >>> thread = api.patch_payment_method(company_id, payment_method_id, content_type, if_match, payment_method, async_req=True)
            >>> result = thread.get()
        ...
        self.patch_payment_method = _Endpoint(
            settings={
                'response_type': (PaymentMethod,),
                'auth': [
                    'oAuth'
            ...
            api_client=api_client,
            callable=__patch_payment_method
        )

        def __post_payment_method(
            self,
            company_id,
            content_type,
            payment_method,
            **kwargs
            ...
            >>> thread = api.post_payment_method(company_id, content_type, payment_method, async_req=True)
            >>> result = thread.get()
        ...
        self.post_payment_method = _Endpoint(
            settings={
                'response_type': (PaymentMethod,),
                'auth': [
                    'oAuth'
                ...
                'endpoint_path': '/companies({company_id})/paymentMethods',
                'operation_id': 'post_payment_method',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__post_payment_method
        )
