...
class JournalApi:
    ...
    def list_journals(
        ...
        _param = self._list_journals_serialize(
    ...
    @validate_call
    def list_journals_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        top: Annotated[Optional[StrictInt], Field(description="(v1.0) Number of items to return from the top of the list")] = None,
        skip: Annotated[Optional[StrictInt], Field(description="(v1.0) Number of items to skip from the list")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListJournals200Response]:
        """Returns a list of journals
    ...
    @validate_call
    def list_journals_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        top: Annotated[Optional[StrictInt], Field(description="(v1.0) Number of items to return from the top of the list")] = None,
        skip: Annotated[Optional[StrictInt], Field(description="(v1.0) Number of items to skip from the list")] = None,
    ...
    def _list_journals_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/companies({company_id})/journals',
    ...
    def post_action_journals(
        ...
        _param = self._post_action_journals_serialize(
            company_id=company_id,
    ...
    @validate_call
    def post_action_journals_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        journal_id: Annotated[StrictStr, Field(description="(v1.0) id for journal")],
        _request_timeout: Union[
    ...
    @validate_call
    def post_action_journals_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        journal_id: Annotated[StrictStr, Field(description="(v1.0) id for journal")],
        _request_timeout: Union[
    ...
    def _post_action_journals_serialize(
        self,
        company_id,
        journal_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/companies({company_id})/journals({journal_id})/Microsoft.NAV.post',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
