...
class CustomerApi:
    ...
    def delete_customer(
        ...
        customer_id: Annotated[StrictStr, Field(description="(v1.0) id for customer")],
        ...
        :type company_id: str
        :param customer_id: (v1.0) id for customer (required)
    ...
    def _delete_customer_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/companies({company_id})/customers({customer_id})',
    ...
    def _list_customers_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/companies({company_id})/customers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_customer(
        ...
        :type if_match: str
        :param post_customer_request: (required)
        :type post_customer_request: PostCustomerRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_customer_serialize(
            company_id=company_id,
            customer_id=customer_id,
    ...
    @validate_call
    def patch_customer_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        customer_id: Annotated[StrictStr, Field(description="(v1.0) id for customer")],
        content_type: Annotated[StrictStr, Field(description="(v1.0) application/json")],
    ...
    def _patch_customer_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if post_customer_request is not None:
            _body_params = post_customer_request
    ...
    def post_customer(
        ...
        _param = self._post_customer_serialize(
            company_id=company_id,
            content_type=content_type,
            post_customer_request=post_customer_request,
            expand=expand,
    ...
    @validate_call
    def post_customer_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        content_type: Annotated[StrictStr, Field(description="(v1.0) application/json")],
        post_customer_request: PostCustomerRequest,
    ...
    @validate_call
    def post_customer_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        content_type: Annotated[StrictStr, Field(description="(v1.0) application/json")],
        post_customer_request: PostCustomerRequest,
