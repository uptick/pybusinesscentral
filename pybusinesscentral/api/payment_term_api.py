...
class PaymentTermApi:
    ...
    def delete_payment_term(
        ...
        payment_term_id: Annotated[StrictStr, Field(description="(v1.0) id for paymentTerm")],
        ...
        :type company_id: str
        :param payment_term_id: (v1.0) id for paymentTerm (required)
        ...
        _param = self._delete_payment_term_serialize(
    ...
    @validate_call
    def delete_payment_term_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        payment_term_id: Annotated[StrictStr, Field(description="(v1.0) id for paymentTerm")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_payment_term_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        payment_term_id: Annotated[StrictStr, Field(description="(v1.0) id for paymentTerm")],
        _request_timeout: Union[
    ...
    def _delete_payment_term_serialize(
        self,
        company_id,
        payment_term_id,
        _request_auth,
        ...
        if payment_term_id is not None:
            _path_params['paymentTerm_id'] = payment_term_id
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/companies({company_id})/paymentTerms({paymentTerm_id})',
    ...
    def get_payment_term(
        ...
        _param = self._get_payment_term_serialize(
            company_id=company_id,
            payment_term_id=payment_term_id,
            select=select,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_payment_term_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        payment_term_id: Annotated[StrictStr, Field(description="(v1.0) id for paymentTerm")],
        select: Annotated[Optional[List[StrictStr]], Field(description="(v1.0) Selected properties to be retrieved")] = None,
    ...
    @validate_call
    def get_payment_term_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        payment_term_id: Annotated[StrictStr, Field(description="(v1.0) id for paymentTerm")],
        select: Annotated[Optional[List[StrictStr]], Field(description="(v1.0) Selected properties to be retrieved")] = None,
    ...
    def _get_payment_term_serialize(
        self,
        company_id,
        payment_term_id,
        select,
    ...
    def list_payment_terms(
        ...
        _param = self._list_payment_terms_serialize(
            company_id=company_id,
            top=top,
            skip=skip,
            limit=limit,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListPaymentTerms200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_payment_terms_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        top: Annotated[Optional[StrictInt], Field(description="(v1.0) Number of items to return from the top of the list")] = None,
        skip: Annotated[Optional[StrictInt], Field(description="(v1.0) Number of items to skip from the list")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListPaymentTerms200Response]:
        """Returns a list of paymentTerms
    ...
    @validate_call
    def list_payment_terms_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        top: Annotated[Optional[StrictInt], Field(description="(v1.0) Number of items to return from the top of the list")] = None,
        skip: Annotated[Optional[StrictInt], Field(description="(v1.0) Number of items to skip from the list")] = None,
    ...
    def _list_payment_terms_serialize(
        self,
        company_id,
        top,
        skip,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/companies({company_id})/paymentTerms',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def patch_payment_term(
        ...
        post_payment_term_request: PostPaymentTermRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type if_match: str
        :param post_payment_term_request: (required)
        :type post_payment_term_request: PostPaymentTermRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_payment_term_serialize(
            company_id=company_id,
            payment_term_id=payment_term_id,
            content_type=content_type,
            if_match=if_match,
            post_payment_term_request=post_payment_term_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def patch_payment_term_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        payment_term_id: Annotated[StrictStr, Field(description="(v1.0) id for paymentTerm")],
        content_type: Annotated[StrictStr, Field(description="(v1.0) application/json")],
    ...
    @validate_call
    def patch_payment_term_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        payment_term_id: Annotated[StrictStr, Field(description="(v1.0) id for paymentTerm")],
        content_type: Annotated[StrictStr, Field(description="(v1.0) application/json")],
    ...
    def _patch_payment_term_serialize(
        self,
        company_id,
        payment_term_id,
        content_type,
        if_match,
        post_payment_term_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_payment_term_request is not None:
            _body_params = post_payment_term_request
    ...
    def post_payment_term(
        ...
        _param = self._post_payment_term_serialize(
            company_id=company_id,
            content_type=content_type,
            post_payment_term_request=post_payment_term_request,
            _request_auth=_request_auth,
    ...
    @validate_call
    def post_payment_term_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        content_type: Annotated[StrictStr, Field(description="(v1.0) application/json")],
        post_payment_term_request: PostPaymentTermRequest,
    ...
    @validate_call
    def post_payment_term_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="(v1.0) id for company")],
        content_type: Annotated[StrictStr, Field(description="(v1.0) application/json")],
        post_payment_term_request: PostPaymentTermRequest,
    ...
    def _post_payment_term_serialize(
        self,
        company_id,
        content_type,
        post_payment_term_request,
